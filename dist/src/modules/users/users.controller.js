...
__decorate([
    ...
    (0, swagger_1.ApiOperation)({ summary: 'Get all delivery addresses for authenticated customer' }),
    __param(0, (0, current_user_decorator_1.CurrentUser)('userId')),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [String]),
    __metadata("design:returntype", Promise)
...
__decorate([
    ...
    (0, swagger_1.ApiOperation)({ summary: 'Create a new delivery address' }),
    __param(0, (0, current_user_decorator_1.CurrentUser)('userId')),
    __param(1, (0, common_1.Body)()),
    __metadata("design:type", Function),
...
__decorate([
    ...
    (0, swagger_1.ApiOperation)({ summary: 'Update a delivery address' }),
    __param(0, (0, current_user_decorator_1.CurrentUser)('userId')),
...
__decorate([
    ...
    (0, swagger_1.ApiOperation)({ summary: 'Set address as default delivery address' }),
    __param(0, (0, current_user_decorator_1.CurrentUser)('userId')),
    __param(1, (0, common_1.Param)('id')),
    __metadata("design:type", Function),
...
__decorate([
    ...
    (0, swagger_1.ApiOperation)({ summary: 'Delete a delivery address' }),
    __param(0, (0, current_user_decorator_1.CurrentUser)('userId')),
    __param(1, (0, common_1.Param)('id')),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [String, String]),
...
exports.UsersController = UsersController = __decorate([
    (0, swagger_1.ApiTags)('Users & Addresses'),
