...
export declare class AdminInventoryController {
    ...
    reserveStock(variantId: string, dto: ReserveStockDto, adminUserId: string): Promise<{
        id: string;
        createdAt: Date;
        updatedAt: Date;
        variantId: string;
    ...
    releaseStock(variantId: string, dto: ReleaseStockDto, adminUserId: string): Promise<{
        id: string;
        createdAt: Date;
        updatedAt: Date;
        variantId: string;
    ...
    updateThreshold(variantId: string, dto: UpdateThresholdDto): Promise<{
        id: string;
        createdAt: Date;
        updatedAt: Date;
        variantId: string;
