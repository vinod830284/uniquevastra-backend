...
export declare class OrdersService {
    ...
    constructor(repository: OrdersRepository, pricingService: PricingService, inventoryTransactionService: InventoryTransactionService, couponsService: CouponsService, prisma: PrismaService);
    ...
    updateStatusAdmin(orderId: string, dto: UpdateOrderStatusDto, adminUserId: string): Promise<{
        id: string;
        createdAt: Date;
        updatedAt: Date;
        status: import("@prisma/client").$Enums.OrderStatus;
